...
Internet searches that happen each day leave the behavior log that analysts 
use to improve search engines. Without such a large record, sites such 
as Google and Bing will never be able to use 2.4 words in an average 
Internet search and turn it into useful content.
...
They determined the family context factor - not smoking during pregnancy - related 
to criminal convictions. This recognition can greatly improve interventions: 
